...
axi_interconnect #(
   ...
   .SLV_NUM        ( SLV_NUM ),
   .SLV_BUF_EN     ( 2'b01 ),
   .SLV_BUF_DEPTH  ( {16'd4, 16'd256} ),
   .SLV_PRIORITY   ( {2'h3, 2'h1} ),
   .MST_BUF_EN     ( 4'b0101 ),
   .MST_BUF_DEPTH  ( {16'd0, 16'd4, 16'd0, 16'd4} ),
   .MST_START_ADDR ( {32'h0000_3000, 32'h0000_2000, 32'h0000_1000, 32'h0000_0000} ),
   .MST_END_ADDR   ( {32'h0000_3FFF, 32'h0000_2FFF, 32'h0000_1FFF, 32'h0000_0FFF} ),
